...
--
-- Table structure for table `result_s_4`
--

DROP TABLE IF EXISTS `result_s_4`;
CREATE TABLE IF NOT EXISTS `result_s_4` (
...
--
-- Dumping data for table `result_s_4`
--

INSERT INTO `result_s_4` (`Course_Name`, `Teacher_Name`, `Credits`, `Semester`, `Mid`, `Sessional`, `Final`) VALUES
...
--
-- Constraints for table `result_s_4`
--
ALTER TABLE `result_s_4`
  ADD CONSTRAINT `Result_S_4_ibfk_4` FOREIGN KEY (`Course_Name`) REFERENCES `enrollments_s_4` (`Course_Name`);
COMMIT;
