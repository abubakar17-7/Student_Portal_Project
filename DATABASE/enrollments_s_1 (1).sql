...
--
-- Table structure for table `enrollments_s_1`
--

DROP TABLE IF EXISTS `enrollments_s_1`;
CREATE TABLE IF NOT EXISTS `enrollments_s_1` (
...
--
-- Dumping data for table `enrollments_s_1`
--

INSERT INTO `enrollments_s_1` (`Course_Name`, `Teacher_Name`, `Credits`, `Semester`) VALUES
...
--
-- Constraints for table `enrollments_s_1`
--
ALTER TABLE `enrollments_s_1`
  ADD CONSTRAINT `Enrollments_S_1_ibfk_1` FOREIGN KEY (`Course_Name`) REFERENCES `courses` (`Course_Name`);
COMMIT;
