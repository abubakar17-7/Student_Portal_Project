...
--
-- Table structure for table `result_s_1`
--

DROP TABLE IF EXISTS `result_s_1`;
CREATE TABLE IF NOT EXISTS `result_s_1` (
...
--
-- Dumping data for table `result_s_1`
--

INSERT INTO `result_s_1` (`Course_Name`, `Teacher_Name`, `Credits`, `Semester`, `Mid`, `Sessional`, `Final`) VALUES
...
--
-- Constraints for table `result_s_1`
--
ALTER TABLE `result_s_1`
  ADD CONSTRAINT `Result_S_1_ibfk_1` FOREIGN KEY (`Course_Name`) REFERENCES `enrollments_s_1` (`Course_Name`);
COMMIT;
