...
--
-- Table structure for table `enrollments_s_4`
--

DROP TABLE IF EXISTS `enrollments_s_4`;
CREATE TABLE IF NOT EXISTS `enrollments_s_4` (
...
--
-- Dumping data for table `enrollments_s_4`
--

INSERT INTO `enrollments_s_4` (`Course_Name`, `Teacher_Name`, `Credits`, `Semester`) VALUES
...
--
-- Constraints for table `enrollments_s_4`
--
ALTER TABLE `enrollments_s_4`
  ADD CONSTRAINT `Enrollments_S_4_ibfk_4` FOREIGN KEY (`Course_Name`) REFERENCES `courses` (`Course_Name`);
COMMIT;
