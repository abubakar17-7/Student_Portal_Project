...
--
-- Table structure for table `result_s_2`
--

DROP TABLE IF EXISTS `result_s_2`;
CREATE TABLE IF NOT EXISTS `result_s_2` (
...
--
-- Dumping data for table `result_s_2`
--

INSERT INTO `result_s_2` (`Course_Name`, `Teacher_Name`, `Credits`, `Semester`, `Mid`, `Sessional`, `Final`) VALUES
...
--
-- Constraints for table `result_s_2`
--
ALTER TABLE `result_s_2`
  ADD CONSTRAINT `Result_S_2_ibfk_2` FOREIGN KEY (`Course_Name`) REFERENCES `enrollments_s_2` (`Course_Name`);
COMMIT;
