...
--
-- Table structure for table `enrollments_s_3`
--

DROP TABLE IF EXISTS `enrollments_s_3`;
CREATE TABLE IF NOT EXISTS `enrollments_s_3` (
...
--
-- Dumping data for table `enrollments_s_3`
--

INSERT INTO `enrollments_s_3` (`Course_Name`, `Teacher_Name`, `Credits`, `Semester`) VALUES
...
--
-- Constraints for table `enrollments_s_3`
--
ALTER TABLE `enrollments_s_3`
  ADD CONSTRAINT `Enrollments_S_3_ibfk_3` FOREIGN KEY (`Course_Name`) REFERENCES `courses` (`Course_Name`);
COMMIT;
